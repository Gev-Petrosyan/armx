...
<body>
    ...
    <main>
        ...
        <div class="company-info">
            <form method="POST" action="{{route("createCategory")}}" enctype="multipart/form-data" style="display:flex">
                @csrf
                ...
                <div class="product-inputs">
                    <div class="input-group">
                        ...
                        <input type="name" id="category" name="category" value="{{old("category")}}" required>
                    </div>
                    <div class="input-group">
